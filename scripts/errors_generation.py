...
def word_place_shuffling(input_file_path, output_file_path, num_lines):
...
word_place_shuffling('../final_corpora/correction_task/corpus.err', '../final_corpora/correction_task/inv.txt', 10000)
